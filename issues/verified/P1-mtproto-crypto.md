...
## QA — 2026-04-16
Pass. 1735/1735 tests green + new tests/functional/test_mtproto_crypto_functional.c exercises real OpenSSL SHA256 (no mock masking). Key derivation verified: msg_key || auth_key[x:x+36] order, 8+16+8 and 8+16+8 key/IV splits, exact 32-byte slice at offset 88+x for compute_msg_key. No uninitialised data in encrypt/decrypt paths under Valgrind.
